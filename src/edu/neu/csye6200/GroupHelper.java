...
//			
			if(flag == 0) {
				...
				parseAndAdd(studentAgeGroups.get(flag), 4, 13);
			} else if(flag == 1) {
				System.out.println("calling 1");
				parseAndAdd(studentAgeGroups.get(flag), 5, 13);
			} else if(flag == 2) {
				System.out.println("calling 2");
				studentAgeGroups.get(flag);
				parseAndAdd(studentAgeGroups.get(flag), 6, 13);
			} else if(flag == 3) {
				System.out.println("calling 3");
				parseAndAdd(studentAgeGroups.get(flag), 8, 13);
			} else if(flag == 4) {
				System.out.println("calling 4");
				parseAndAdd(studentAgeGroups.get(flag), 12, 13);
			} else if(flag == 5) {
				parseAndAdd(studentAgeGroups.get(flag), 15, 13);
			}
