			...
			public void actionPerformed(ActionEvent e) {
				...
				JButton addStudent = new JButton("Add Student");
		         ...
		         addStudent.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						// TODO Auto-generated method stub
						if(fname.getText().equals("")||lname.getText().equals("")||ddate.getText().equals("")||idT.getText().equals("")||addT.getText().equals("")||phoneNum.getText().equals("")||gT.getText().equals("")||emailT.getText().equals("")) {
							alert.setText("Enter valid details.");
						}
						else
						{
